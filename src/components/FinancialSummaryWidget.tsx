...
const FinancialSummaryWidget: React.FC<FinancialSummaryWidgetProps> = memo(({
  income,
  totalExpenses,
  darkMode,
  onEditIncome
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-col items-start min-w-0">
          ...
          <span className={`text-xs sm:text-sm font-bold truncate ${available >= 0
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`font-bold text-lg ${available >= 0
                    ? 'text-green-600 dark:text-green-400'
                    : 'text-red-600 dark:text-red-400'
                    }`}>
                    {available.toFixed(0)}€
                ...
                {income && income > 0 && (
                  <div className={`p-3 rounded-lg ${darkMode ? 'bg-gray-750' : 'bg-gray-50'
                    ...
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className={`text-xs font-semibold ${Number(spentPercentage) >= 90
                        ? 'text-red-600 dark:text-red-400'
                    ...
                    <div className={`h-2 rounded-full overflow-hidden ${darkMode ? 'bg-gray-700' : 'bg-gray-200'
                      ...
                      <motion.div
                        ...
                        className={`h-full rounded-full ${Number(spentPercentage) >= 90
