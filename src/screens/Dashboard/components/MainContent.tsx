  ...
  ({
    ...
    return (
      ...
      >
        ...
        <div
          className="md:hidden sticky left-0 right-0 z-[100] pointer-events-none"
          style={{
            bottom: "0",
          }}
        >
                      ...
                      {(() => {
                        ...
                        return (
                          <>
                            ...
                            >
                              Calendario de Gastos - {monthNames[displayMonth]}{" "}
                              {displayYear}
                            </h3>
                                      ...
                                      fill={
                                        entry.amount > 0
                                          ? darkMode
                                            ? `rgba(147, 51, 234, ${
                                                0.4 +
                                                (entry.amount / maxAmount) * 0.6
                                              })`
                                            : `rgba(139, 92, 246, ${
                                                0.5 +
                                                (entry.amount / maxAmount) * 0.5
                                              })`
                                          : darkMode
                                          ? "#374151"
                                          : "#e5e7eb"
