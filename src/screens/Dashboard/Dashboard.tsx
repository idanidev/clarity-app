...
const Dashboard = ({ user }: DashboardProps) => {
  ...
  // ✅ Detectar cambios de conexión usando ref para evitar dependencias
  useEffect(() => {
    const handleOnline = () => {
  ...
  // ✅ Handlers memoizados para AddExpenseModal
  ...
  return (
    ...
    >
      ...
      <Suspense fallback={showAddExpense ? <ModalLoader /> : null}>
        {showAddExpense && <AddExpenseModal {...addExpenseModalProps} />}
      </Suspense>
